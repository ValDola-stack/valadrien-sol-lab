 ...
 * chat relay that spawns the `claude` CLI with the valadrien-os-board skill as
...
export function boardChatRoutes(
  ...
  // repo-root `skills/valadrien-os-board/SKILL.md` whether running from
  ...
  function loadBoardSkill(): string {
    ...
    const skillPath = path.resolve(here, "../../../skills/valadrien-os-board/SKILL.md");
    try {
      ...
      return (
        ...
        "company through ValadrienOs. Help them create companies, hire agents, " +
